...
# constants
url = 'http://utg.ua/wp-content/uploads/cdd/ARCHIVE/EN/'
dir_raw = 'gvs_raw_en'
link_pattern = 'AllGMS'
rar_file = 'AllGMS_UTG_en.rar'
title_str = 'utg_gvs_en'
...
def get_gas_data(file):
    ...
    df['date'] = file
    df['date'] = df['date'].str.replace('AllGMS_UTG_en_', '').str.replace('.xlsx', '')
